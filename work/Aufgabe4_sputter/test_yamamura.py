...
config_file = os.path.join(filedir,'yamamura.cfg')
mini_topsim(config_file)

@pytest.fixture()
def calc_distance():
    """
    calculates distance between yamamura.srf and yamamura.srf_save  
    """
        
    srf_filename1 = os.path.join(filedir,'yamamura.srf')
    srf_filename2 = os.path.join(filedir,'yamamura.srf_save')
...
def test_calc_distance(calc_distance):
    ...
    calculates distance between yamamura.srf and yamamura.srf_save and
